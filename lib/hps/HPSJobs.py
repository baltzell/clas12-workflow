...
class EvioTriggerFilterJob(SwifJob):
  ...
  def setCmd(self):
    ...
    cmd+='/home/holtrop/bin/HPS_Trigger_Filter -T 11 -o out_muons.evio ./*.evio* ;'
    cmd+='ls -lhtr ; '
    ...
    job.addOutput('out_muons.evio','%s/muons/%.6d/%s'%(cfg['outDir'],rf1.runNumber,outfile.replace('hps_','hps_muons_')))
