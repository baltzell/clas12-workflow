...
import swif
from clas12.CLAS12SwifStatus import CLAS12SwifStatus
...
#      status.moveJobLogs()
  ...
  if args.delete:
    swif.SwifStatus.deleteWorkflow(workflow)
    return
...
if __name__ == '__main__':
  ...
  problem_types = swif.SwifStatus.SWIF_PROBLEMS[:]
